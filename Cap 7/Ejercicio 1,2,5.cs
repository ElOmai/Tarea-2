...
namespace Ejercicios_del_5_8.Cap_7
{
    public class Ejercicio_1_2_5
    {
        ...
        {
            Console.Clear();
            Console.Write("1.Ejercicio 1\n2.Ejercicio 2\n5.Ejercicio 5\nDijite el Numero De La Opcion Deseada: ");
        ...
        public void Diccionario()
        {
            ...
            Diccionario.Add("asesinar", "Salar cualquier tipo de carne ahumada");
            do
            {
                Console.WriteLine("Tenemos las palabras: abaceria, abominar y asesinar  ");
